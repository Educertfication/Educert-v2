...
const Aboutsection = () => {
  return (
    <div>
        <Image src="/groupicon.png" alt='sponsor' width={347} height={200} className="mt-[80px] sm:w-[347px] xsm:w-[330px]" unoptimized />
        <div className="flex sm:hidden justify-between space-x-10 xxl:w-[1200px] xl:mx-auto xxl:mx-auto mt-[50px]">
            <Image src="/man.png" alt='man' width={200} height={200} className="sm:hidden" unoptimized />
            <div>
