...
const Card = (prop) => {
  return (
    <div className="w-[377px] sm:w-[347px] h-[251px] border border-[#EEEEF06B] rounded-[10px] bg-[#130425] mt-[20px] py-[25px] px-[15px]">
            ...
            <Image src={prop.src} alt='img' width={prop.width || 347} height={prop.height || 200} unoptimized />
            <Image src="/star.png" alt='star' width={20} height={20} className="h-[20px] mt-[2px]" unoptimized />
            </div>
